...
df_drugs_smiles = pd.read_csv('/content/drive/MyDrive/reserch_files/data/drug_smiles.csv')
...
df_all_pos_ddi = pd.read_csv('/content/drive/MyDrive/reserch_files/data/ddis.csv')
